    ...
    <main className="wallet-payment-page payment-success-page">
      <section className="wallet-success-card payment-success-card">
        ...
        <div className="wallet-success-card__actions payment-success-card__actions">
          <button type="button" className="btn btn-primary" onClick={onPrimary}>Continue to {isCall ? 'Call' : 'Chat'} →</button>
          <button type="button" className="btn btn-outline" onClick={onBack}>Back to Dashboard</button>
        </div>
      </section>
    </main>
  )
