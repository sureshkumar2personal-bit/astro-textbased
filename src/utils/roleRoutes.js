...
export function getRoleRoutes(role) {
  ...
  return {
    ...
    appointmentBook: `${base}/appointments/book`,
    ...
    chatAstrologers: `${base}/chat-astrologers`,
    callAstrologers: `${base}/call-astrologers`,
    ...
    addPaymentMethod: `${base}/payment-methods/add`,
    autopay: `${base}/autopay`,
